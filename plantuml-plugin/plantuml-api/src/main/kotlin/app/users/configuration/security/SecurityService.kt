package app.users.configuration.security

import app.users.configuration.Constants.AUTHORITIES_KEY
import app.users.configuration.Constants.INVALID_TOKEN
import app.users.configuration.Constants.VALID_TOKEN
import app.users.configuration.Loggers
import app.users.configuration.Loggers.d
import app.users.configuration.Loggers.i
import app.users.configuration.Loggers.t
...
private fun ApplicationContext.userDetails(emailOrLogin: String)
        : Mono<UserDetails> = empty()
