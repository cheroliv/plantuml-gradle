...
class AttemptHistorySteps {
    ...
    private var result: plantuml.PlantumlDiagram? = null
    ...
    fun setup() {
        ...
        plantumlService = mock(PlantumlService::class.java)
    ...
    fun then_attempt_history_should_be_archived_with_entries(count: Int) {
        ...
        verify(plantumlService, times(count)).validateSyntax(anyString())
    }
